...
for i in range(0,num):
    ...
    json = response.json()
    customers_writer.writerow([i,json['identification']['full_name'], json['financial_information']['credit_card_number'], json['financial_information']['cvv2'], json['financial_information']['expiration_date']])
    products_orders_writer.writerow()
    orders_writer.writerow([json['contact_information']['home_address']])